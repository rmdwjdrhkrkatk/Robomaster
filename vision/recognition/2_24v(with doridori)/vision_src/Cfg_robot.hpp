...
static bool configure_number_robot(VisionDataset& data) {
    ...
    for (index = 1; index < 3; index++) {
        ...
        if (armour[index].number_of_armer == 0) {

            armour[index].number_of_armer = 1;
    ...
    for (index = 1; index < 3; index++) {
        ...
        for (index2 = 0; index2 < 6; index2++) {
            ...
            if (armour[index].armour_type[index2] == Number1) {

                number_of_1++;

                confidence_of_1 = confidence_of_1 + armour[index].armour_confidence[index2];

            }

            if (armour[index].armour_type[index2] == Number2) {

                number_of_2++;

                confidence_of_2 = confidence_of_2 + armour[index].armour_confidence[index2];
        ...
        std::cout << "(configure_number_robot) Nmber of 1:" << number_of_1<<" Nmber of 2:"<< number_of_2<<std::endl;

#endif

        if (number_of_1 == 0 && number_of_2==0){
        ...
        if (number_of_1 > number_of_2 && !number1_assigned) {
            ...
            std::cout << "(configure_number_robot) Number 1 is assigned" << std::endl;
        ...
        else if (number_of_2 > number_of_1 && !number2_assigned) {
            ...
            std::cout << "(configure_number_robot) Number 2 is assigned" << std::endl;

#endif

        }

        else if (number1_assigned == true && confidence_of_1 != 0) {  //second loop



#ifdef DEBUG

            std::cout << "before Number1`s confidence : " << old_confidence_1 << ",New Number1`s confidence," << confidence_of_1 << std::endl;

			std::cout << "before Number1`s number of armour : " << data.armour[index - 1].number_of_armer << " Number1`s number of armour :" << data.armour[index].number_of_armer << std::endl;
            ...
            if ((old_confidence_1 / data.armour[index - 1].number_of_armer) > (confidence_of_1 / data.armour[index].number_of_armer)) {
                ...
                std::cout << "(configure_number_robot) Number 1 and Number 2 is assigned" << std::endl;
                ...
                std::cout << "(configure_number_robot) Number 1 became Number 2 , and Number 1 is reassigned" << std::endl;
        ...
        else if (number2_assigned == true && confidence_of_2 != 0 ) {//second loop



#ifdef DEBUG

            std::cout << "before Number2`s confidence : " << old_confidence_2 << ",New Number2`s confidence," << confidence_of_2 << std::endl;

			std::cout << "before Number2`s number of armour : " << data.armour[index - 1].number_of_armer << " Number2`s number of armour :" << data.armour[index].number_of_armer << std::endl;

#endif

            if ((old_confidence_2 / armour[index - 1].number_of_armer) > (confidence_of_2 / armour[index].number_of_armer)) {
            ...
            else if ((old_confidence_2 / armour[index - 1].number_of_armer) < (confidence_of_2 / armour[index].number_of_armer)) {
        ...
        else if (confidence_of_1 / armour[index].number_of_armer > confidence_of_2 / armour[index].number_of_armer && number1_assigned == false) {
        ...
        else if (confidence_of_1 / armour[index].number_of_armer < confidence_of_2 / armour[index].number_of_armer && number2_assigned == false) {
            ...
            std::cout << "(configure_number_robot) Number of 1 and 2 `s armour is same" << std::endl;
    ...
    for (index = 1; index < 3; index++) {
        ...
        if (data.armour[index].Center_x == 0) {

            data.armour[index].number_of_armer = 0;

#ifdef DEBUG

            std::cout << "(configure_number_robot)  "<< index <<"`s armour is not found" << std::endl;
    ...
    std::cout << "(configure_number_robot) is worked" << std::endl;
