...
#ifdef DEBUG
	std::cout << "(VisionDataset_initialize)_is worked" << endl;
#endif
...
#ifdef DEBUG
	std::cout << "(sendDataset_initialize)_is worked" << endl;
#endif
...
static bool VisionDataset_checker(int numberofdetection) {
	...
	{
#ifdef DEBUG
		std::cout << "(VisionDataset_checker)_numberofdetection is zero" << endl;
#endif
		return true;
	}
...
#ifdef DEBUG
	std::cout << "(VisionDataset_KCFCORMaker)" << " dataset.KCF_X[0]:" <<dataset.KCF_X[0]<< " dataset.KCF_X[1]:"  <<dataset.KCF_X[1]<<" dataset.KCF_X[2]:"  <<dataset.KCF_X[2] <<endl;
#endif
}
