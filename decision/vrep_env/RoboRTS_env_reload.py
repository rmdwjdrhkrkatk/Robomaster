...
class RoboRTS:
    ...
    def step(self):
        for i in range(40):
            ...
            vrep.simxSynchronousTrigger(self.clientID)
        for i in range(30):
            print('| robot1 : ', 'reload zone' , ' | robot2 : ','reload zone cover |')
            self.setMotorSpeeds1([0.,1.,0])
            self.setMotorSpeeds2([0.,3.,-1.])
        ...
        for i in range(30):
            print('| robot1 : ', 'reload zone' , ' | robot2 : ','reload zone cover |')
            self.setMotorSpeeds1([0.,2.,3.])
            self.setMotorSpeeds2([0.,2.2,0])
