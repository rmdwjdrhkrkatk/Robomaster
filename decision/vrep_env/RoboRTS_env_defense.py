...
class RoboRTS:
    ...
    def step(self):
        ...
        for i in range(20):
            ...
            self.setMotorSpeeds1([0.,2.,15.])
            self.setMotorSpeeds2([0.,2.,-3.])
        
            self.setMotorSpeeds3([0.,3.,0.])
            self.setMotorSpeeds4([0.,2.,0.])
        ...
        for i in range(30):
            print('| robot1 : ', 'patrol' , ' | robot2 : ','patrol |')
            self.setMotorSpeeds1([0.,2.,-5.])
            self.setMotorSpeeds2([0.,2.,9.])

            self.setMotorSpeeds3([0.,2.,0.])
            self.setMotorSpeeds4([0.,1.5,0.])

            vrep.simxSynchronousTrigger(self.clientID)
        for i in range(30):
            print('| robot1 : ', 'fight' , ' | robot2 : ','fight |')
            self.setMotorSpeeds1([0.,0.5,3.])
            self.setMotorSpeeds2([0.,0.5,-5.])

            self.setMotorSpeeds3([0.,1.,5.])
            self.setMotorSpeeds4([0.,0.5,-1.])
            vrep.simxSynchronousTrigger(self.clientID)
        for i in range(10):
            print('| robot1 : ', 'defense zone' , ' | robot2 : ','defense zone cover |')
            self.setMotorSpeeds1([0.,-4.,2.])
            self.setMotorSpeeds2([0.,-2.,-2.])

            self.setMotorSpeeds3([0.,1.5,-5.])
            self.setMotorSpeeds4([0.,1.,3.])
            vrep.simxSynchronousTrigger(self.clientID)

        for i in range(47):
            print('| robot1 : ', 'defense zone' , ' | robot2 : ','defense zone cover |')
            self.setMotorSpeeds1([0.,-5.,-10.])
            self.setMotorSpeeds2([0.,-2,-1.5])
            

            self.setMotorSpeeds3([0.,3.,-8.])
            self.setMotorSpeeds4([0.,3.,3.])
            self.projectorcontrol1(-10.)
            self.projectorcontrol2(-10.)
            vrep.simxSynchronousTrigger(self.clientID)
        for i in range(7):
            print('| robot1 : ', 'defense zone' , ' | robot2 : ','defense zone cover |')
            self.setMotorSpeeds1([0.,-2.,0.])
        ...
        for i in range(20):
            ...
            self.setMotorSpeeds3([0.,1.,0.])
            self.setMotorSpeeds4([0.,1.,0.])
