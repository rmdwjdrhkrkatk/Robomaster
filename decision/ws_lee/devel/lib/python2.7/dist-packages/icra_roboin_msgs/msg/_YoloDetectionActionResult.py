...
"""autogenerated by genpy from icra_roboin_msgs/YoloDetectionActionResult.msg. Do not edit."""
import sys
...
class YoloDetectionActionResult(genpy.Message):
  _md5sum = "2a42918724c567b048b06f7ef1de0d8c"
  _type = "icra_roboin_msgs/YoloDetectionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','icra_roboin_msgs/YoloDetectionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(YoloDetectionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = icra_roboin_msgs.msg.YoloDetectionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = icra_roboin_msgs.msg.YoloDetectionResult()
