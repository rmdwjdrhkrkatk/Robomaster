...
class YawGainRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type YawGainRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type YawGainRequest
    let len;
    let data = new YawGainRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new YawGainRequest(null);
    if (msg.p !== undefined) {
      resolved.p = msg.p;
    }
    else {
...
class YawGainResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type YawGainResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type YawGainResponse
    let len;
    let data = new YawGainResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new YawGainResponse(null);
...
module.exports = {
  Request: YawGainRequest,
  Response: YawGainResponse,
  md5sum() { return '223542de9427e9df0f0b5bfbdc1715cb'; },
  datatype() { return 'icra_roboin_msgs/YawGain'; }
};
